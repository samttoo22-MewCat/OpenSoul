...
def main():
    ...
    parser.add_argument("--command", choices=["read", "append", "replace"], required=True, help="執行動作 (read, append, replace)")
    parser.add_argument("--text", help="附加或替換的文字內容 (read 動作無需此參數)")
